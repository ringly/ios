...
final class ActivityGoalViewController: ServicesViewController
{
    // MARK: - Stack Views
    ...
    fileprivate let activityGoalPicker = SettingsPickerView.newAutoLayout()
    ...
    override func loadView()
    {
        ...
        rootStack.addArrangedSubview(activityGoalPicker)
    ...
    override func viewDidLoad()
    {
        ...
        activityGoalPicker.actionsProducer.startWithValues({ action in
        ...
        activityGoalPicker.title = "STEPS"
        ...
        activityGoalPicker.quantityComponents <~ services.preferences.activityTrackingStepsGoal.producer.map({ steps in
